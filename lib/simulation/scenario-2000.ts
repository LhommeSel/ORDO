...
export function createFrance2000World(): WorldState {
  return {
    ...
    energyContracts: {},
    countryEnergy: {
      FRA: { countryId: 'FRA', annualDemand: { oil: 92, gas: 46 }, domesticProduction: { oil: 2, gas: 3 }, strategicStocks: { oil: 24, gas: 3 }, storageCapacity: { oil: 34, gas: 12 }, desiredCoverageMonths: { oil: 3, gas: 1.5 } },
      DEU: { countryId: 'DEU', annualDemand: { oil: 128, gas: 78 }, domesticProduction: { oil: 4, gas: 18 }, strategicStocks: { oil: 29, gas: 9 }, storageCapacity: { oil: 41, gas: 24 }, desiredCoverageMonths: { oil: 3, gas: 2 } },
      ITA: { countryId: 'ITA', annualDemand: { oil: 96, gas: 60 }, domesticProduction: { oil: 5, gas: 15 }, strategicStocks: { oil: 18, gas: 5 }, storageCapacity: { oil: 30, gas: 18 }, desiredCoverageMonths: { oil: 2.5, gas: 1.5 } },
      POL: { countryId: 'POL', annualDemand: { oil: 24, gas: 14 }, domesticProduction: { oil: 1, gas: 5 }, strategicStocks: { oil: 4, gas: 1 }, storageCapacity: { oil: 8, gas: 4 }, desiredCoverageMonths: { oil: 2, gas: 1 } },
      GBR: { countryId: 'GBR', annualDemand: { oil: 82, gas: 88 }, domesticProduction: { oil: 128, gas: 96 }, strategicStocks: { oil: 11, gas: 2 }, storageCapacity: { oil: 20, gas: 8 }, desiredCoverageMonths: { oil: 1.5, gas: 0.8 } },
      USA: { countryId: 'USA', annualDemand: { oil: 820, gas: 650 }, domesticProduction: { oil: 370, gas: 520 }, strategicStocks: { oil: 92, gas: 25 }, storageCapacity: { oil: 125, gas: 70 }, desiredCoverageMonths: { oil: 3, gas: 1.5 } },
      RUS: { countryId: 'RUS', annualDemand: { oil: 125, gas: 330 }, domesticProduction: { oil: 325, gas: 520 }, strategicStocks: { oil: 28, gas: 60 }, storageCapacity: { oil: 45, gas: 95 }, desiredCoverageMonths: { oil: 2, gas: 2 } },
      CHN: { countryId: 'CHN', annualDemand: { oil: 210, gas: 28 }, domesticProduction: { oil: 160, gas: 24 }, strategicStocks: { oil: 10, gas: 1 }, storageCapacity: { oil: 28, gas: 5 }, desiredCoverageMonths: { oil: 1, gas: 0.5 } },
      NOR: { countryId: 'NOR', annualDemand: { oil: 10, gas: 5 }, domesticProduction: { oil: 150, gas: 62 }, strategicStocks: { oil: 11, gas: 5 }, storageCapacity: { oil: 18, gas: 10 }, desiredCoverageMonths: { oil: 2, gas: 2 } },
      DZA: { countryId: 'DZA', annualDemand: { oil: 18, gas: 24 }, domesticProduction: { oil: 70, gas: 88 }, strategicStocks: { oil: 8, gas: 9 }, storageCapacity: { oil: 14, gas: 18 }, desiredCoverageMonths: { oil: 2, gas: 2 } },
      LBY: { countryId: 'LBY', annualDemand: { oil: 12, gas: 6 }, domesticProduction: { oil: 70, gas: 12 }, strategicStocks: { oil: 10, gas: 2 }, storageCapacity: { oil: 20, gas: 5 }, desiredCoverageMonths: { oil: 2, gas: 1 } },
      SAU: { countryId: 'SAU', annualDemand: { oil: 65, gas: 55 }, domesticProduction: { oil: 430, gas: 58 }, strategicStocks: { oil: 42, gas: 4 }, storageCapacity: { oil: 70, gas: 12 }, desiredCoverageMonths: { oil: 2, gas: 1 } },
    },
