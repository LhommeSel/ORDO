...
const allCountries: Record<string, CountryState> = {
  ...
  CAN: country({
    ...
    politics: {
      ...
      publicApproval: 56, administrativeCompliance: 84,
      doctrine: { economic: 8, social: 28, sovereignty: 26, security: 22 },
    },
    strategy: {
      goals: [
        { id: 'can-continental-prosperity', label: 'Préserver la prospérité nord-américaine', priority: 92, progress: 66, status: 'active' },
        { id: 'can-arctic-sovereignty', label: 'Consolider la souveraineté arctique', priority: 70, progress: 44, status: 'active' },
      ],
      vulnerabilities: ['Forte intégration au marché américain', 'Écarts de développement entre provinces', 'Dépendance aux exportations de ressources'],
      redLines: ['Atteinte à la souveraineté territoriale et arctique', 'Rupture brutale des accès commerciaux nord-américains'],
      partners: ['USA', 'GBR', 'FRA'], rivals: [], lastReviewDate: '2000-01-01',
    },
  }),
  MEX: country({
    ...
    politics: {
      ...
      publicApproval: 50, administrativeCompliance: 64,
      doctrine: { economic: 14, social: 10, sovereignty: 58, security: 44 },
    },
    strategy: {
      goals: [
        { id: 'mex-democratic-transition', label: 'Achever une alternance démocratique crédible', priority: 94, progress: 58, status: 'active' },
        { id: 'mex-north-american-integration', label: 'Valoriser l’intégration nord-américaine sans perdre la marge souveraine', priority: 88, progress: 62, status: 'active' },
      ],
      vulnerabilities: ['Dépendance au marché américain', 'Inégalités territoriales', 'Réseaux criminels régionaux'],
      redLines: ['Perte de souveraineté économique imposée', 'Déstabilisation de la transition électorale'],
      partners: ['USA', 'CAN', 'ESP'], rivals: [], lastReviewDate: '2000-01-01',
    },
  }),
};
...
const energyNodes: Record<string, EnergyNode> = {
  ...
  'can-oil': { id: 'can-oil', countryId: 'CAN', resource: 'oil', label: 'Ouest canadien et sables bitumineux', provenReserves: 700, probableReserves: 1300, annualProduction: 133, annualCapacity: 142, domesticConsumption: 95, storageCapacity: 35, stocks: 20, extractionCost: 22, declineRate: 0.012, developmentLeadMonths: 54, infrastructure: ['Réseau de l’Ouest canadien', 'Oléoducs continentaux'] },
  'can-gas': { id: 'can-gas', countryId: 'CAN', resource: 'gas', label: 'Bassin sédimentaire de l’Ouest canadien', provenReserves: 1700, probableReserves: 650, annualProduction: 180, annualCapacity: 192, domesticConsumption: 85, storageCapacity: 35, stocks: 18, extractionCost: 11, declineRate: 0.01, developmentLeadMonths: 42, infrastructure: ['Réseau gazier nord-américain', 'Alberta Gas Trunk Line'] },
  'mex-oil': { id: 'mex-oil', countryId: 'MEX', resource: 'oil', label: 'Golfe du Mexique et système Pemex', provenReserves: 3400, probableReserves: 800, annualProduction: 170, annualCapacity: 182, domesticConsumption: 93, storageCapacity: 22, stocks: 10, extractionCost: 12, declineRate: 0.018, developmentLeadMonths: 42, infrastructure: ['Cantarell', 'Terminaux du golfe du Mexique'] },
  'mex-gas': { id: 'mex-gas', countryId: 'MEX', resource: 'gas', label: 'Bassins gaziers mexicains', provenReserves: 410, probableReserves: 220, annualProduction: 40, annualCapacity: 44, domesticConsumption: 42, storageCapacity: 8, stocks: 2, extractionCost: 16, declineRate: 0.014, developmentLeadMonths: 36, infrastructure: ['Réseau gazier du nord-est', 'Interconnexions américaines'] },
...
const baselineEnergyFlows: Record<string, BaselineEnergyFlow> = Object.fromEntries([
  ...
  baselineFlow('usa-oil-sau', 'USA', 'oil', 80, 'Golfe–Atlantique', 'sau-oil'), baselineFlow('usa-oil-ext', 'USA', 'oil', 272, 'Marché continental et maritime'), baselineFlow('usa-gas-ext', 'USA', 'gas', 35, 'Marché continental'),
  baselineFlow('usa-oil-can', 'USA', 'oil', 30, 'Oléoducs continentaux', 'can-oil'), baselineFlow('usa-gas-can', 'USA', 'gas', 95, 'Réseau gazier nord-américain', 'can-gas'),
  baselineFlow('mex-oil-usa', 'USA', 'oil', 68, 'Golfe du Mexique', 'mex-oil'), baselineFlow('mex-gas-ext', 'MEX', 'gas', 2, 'Interconnexions nord-américaines'),
...
export function createWorld2000(requestedPlayerCountryId: CountryId = 'FRA'): WorldState {
  ...
  return {
    ...
    countryEnergy: {
      ...
      CAN: { countryId: 'CAN', annualDemand: { oil: 95, gas: 85 }, domesticProduction: { oil: 133, gas: 180 }, legacyImports: { oil: 0, gas: 0 }, strategicStocks: { oil: 20, gas: 18 }, storageCapacity: { oil: 35, gas: 35 }, desiredCoverageMonths: { oil: 2.5, gas: 2 } },
      MEX: { countryId: 'MEX', annualDemand: { oil: 93, gas: 42 }, domesticProduction: { oil: 170, gas: 40 }, legacyImports: { oil: 0, gas: 2 }, strategicStocks: { oil: 10, gas: 2 }, storageCapacity: { oil: 22, gas: 8 }, desiredCoverageMonths: { oil: 1.5, gas: 0.8 } },
