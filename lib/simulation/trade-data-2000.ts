...
export function createTradeFlows2000(): Record<string, BilateralTradeFlow> {
  ...
  const values = [
    ...
    flow('CAN', 'USA', 230, { energy: 0.28, raw_materials: 0.17, industrial_inputs: 0.25, manufactured_goods: 0.22, food: 0.08 }, 5, 94),
    flow('USA', 'CAN', 178, { manufactured_goods: 0.46, industrial_inputs: 0.28, strategic_technology: 0.17, food: 0.09 }, 5, 94),
    flow('MEX', 'USA', 136, { manufactured_goods: 0.48, industrial_inputs: 0.22, energy: 0.12, food: 0.1, raw_materials: 0.08 }, 6, 88),
    flow('USA', 'MEX', 112, { manufactured_goods: 0.49, industrial_inputs: 0.25, strategic_technology: 0.16, food: 0.1 }, 6, 89),
    flow('CAN', 'MEX', 5, mixed, 9, 82), flow('MEX', 'CAN', 4, mixed, 9, 80),
