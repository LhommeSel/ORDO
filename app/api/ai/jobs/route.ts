  ...
  try {
    ...
    const instructions = [
      ...
      parsed.job.kind === 'diplomacy'
        ...
        : '',
      isFreeDialogue
        ? 'Pour ce dialogue politique libre, diplomaticMove.scope doit être general_dialogue. Décris la position, les concessions possibles, les garanties demandées, les conditions, les lignes rouges et un calendrier en langage naturel. Si le sujet porte sur l’énergie, choisis agreementType=energy_cooperation pour un cadre politique ou logistique ; cela ne crée aucun volume livré ni contrat automatique. Les volumes et les routes physiques passent par la session de négociation énergétique dédiée.'
